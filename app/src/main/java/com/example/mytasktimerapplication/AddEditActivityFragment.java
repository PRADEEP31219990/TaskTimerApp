...
public class AddEditActivityFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(!(activity instanceof OnSaveClicked)){
            throw new ClassCastException(activity.getClass().getSimpleName() + "must implement AddActivityFragment. OnsaveClicked Interface");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDescriptionTextView =  view.findViewById(R.id.addedit_decription);
            ...
            switch (mMode) {
                case EDIT:
                    ...
                    if(!mNameTextView.getText().toString().equals(task.getmName())) {
                        values.put(TasksContract.columns.TASK_NAME, mNameTextView.getText().toString());
                    }
